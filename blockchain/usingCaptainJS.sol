...
contract ICaptainJS {
    ...
    function ActivateVoucherCode(string calldata VoucherCode) external;
    ...
    function RunWithVoucher(uint UniqueJobIdentifier, string calldata JavaScriptCode, string calldata InputParameter, string calldata RequiredNpmPackages, uint RuntimeSlices, uint GasForCallback, uint GasPriceInWei) external payable;
    function RunWithoutVoucher(uint UniqueJobIdentifier, string calldata JavaScriptCode, string calldata InputParameter, string calldata RequiredNpmPackages, uint RuntimeSlices, uint GasForCallback, uint GasPriceInWei) external payable;
...
contract usingCaptainJS {
    ...
    function ActivateVoucher(string memory VoucherCode) public {
    ...
    function Run(uint UniqueJobIdentifier, string storage JavaScriptCode, string storage InputParameter, string storage RequiredNpmPackages, uint RuntimeSlices, uint GasForCallback, uint GasPriceInWei) internal {
        // calculate the price            
    ...
    function CaptainsResult(uint UniqueJobIdentifier, string calldata Result) external onlyCaptainsOrdersAllowed {
        // override in your contract
    }
    
    function CaptainsError(uint UniqueJobIdentifier, string calldata Error) external onlyCaptainsOrdersAllowed {
        // override in your contract
    }
    ...
    function concat(string storage _a, string storage _b, string storage _c, string storage _d, string storage _e) internal pure returns (string storage){
    ...
    function concat(string storage _a, string storage _b) internal pure returns (string storage){
        return concat(_a, _b, "", "", "");
    }

    function concat(string storage _a, string storage _b, string storage _c, string storage _d) internal pure returns (string storage){
        return concat(_a, _b, _c, _d, "");
    }

    function concat(string storage _a, string storage _b, string storage _c) internal pure returns (string storage){
        return concat(_a, _b, _c, "", "");
    }

    function uintToString(uint v) internal pure returns (string storage str) {
        uint maxlength = 100;
    ...
    function StringToUint(string storage s) internal pure returns (uint result) {
